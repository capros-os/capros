...
#define KR_ECHOER        KR_APP(8) /* The key for the client
				      constructor */
...
main(void)
{
  ...
  node_extended_copy(KR_CONSTIT, KC_ECHOER_C, KR_ECHOER);
  ...
  if (constructor_request(KR_ECHOER, KR_BANK, KR_SCHED, KR_SESSION_CREATOR,
			  KR_ECHOER) != RC_OK) {
