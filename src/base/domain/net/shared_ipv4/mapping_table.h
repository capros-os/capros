...
/* Xmit sectors carry this flag */
#define XMIT_CLIENT_SPACE     0    /* Client Rd,Wr Stack Rd,Wr */
#define XMIT_STACK_SPACE      1    /* Client No Perms, Stack Rd,Wr */

/* Recv sectors carry this flag */
#define RECV_CLIENT_SPACE     2
#define RECV_STACK_SPACE      3
