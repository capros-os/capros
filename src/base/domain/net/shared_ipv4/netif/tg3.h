...
struct tg3 {
  ...
  struct tg3_enet_statistics        net_stats;     /* Statistics of service */
...
/* Function prototypes */
uint32_t tg3_interrupt();
uint32_t altima_probe(struct pci_dev_data *net_device,struct netif *net_if);
uint32_t tg3_start_xmit(struct pstore *,int ssid);
uint32_t tg3_rx();
