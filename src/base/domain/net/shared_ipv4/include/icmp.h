...
void icmp_input(struct pstore *p,int ssid,struct netif *netif);
void icmp_dest_unreach(struct pstore *p, enum icmp_dur_type t);
void icmp_time_exceeded(struct pstore *p, enum icmp_te_type t);
