...
struct pstore *etharp_ip_input(struct netif *netif,struct pstore *p,int ssid);
struct pstore *etharp_arp_input(struct netif *netif,struct eth_addr *ethaddr,
				struct pstore *p,int ssid);
struct pstore *etharp_output(struct netif *netif,struct ip_addr *ipaddr,
			     struct pstore *q,int ssid);
uint32_t etharp_query(struct netif *,struct ip_addr *ipaddr, 
		      struct pstore *q,int ssid);
