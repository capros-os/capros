...
/* Generic functions for the network interface */
uint32_t netif_probe();
uint32_t netif_interrupt();
uint32_t netif_start_xmit();

/* IDs of some cards */
#define LANCE   0x2621
#define TORNADO 0x9200
#define ALTIMA  0x173B
#endif /*__netif_h__*/
