...
/*ARGSUSED*/
void
db_delete_cmd(db_expr_t addr, int i/* have_addr */,
	      db_expr_t c/* count */, char * m/* modif */)
{
...
/*ARGSUSED*/
void
db_breakpoint_cmd(db_expr_t addr, int h/* have_addr */, db_expr_t count,
		  char * m/* modif */)
{
	if (count == -1)
	    count = 1;
...
/* list breakpoints */
void
db_listbreak_cmd(db_expr_t a/* addr */, int h/* have_addr */,
		 db_expr_t c/* count */, char * m/* modif */)
{
	db_list_breakpoints();
}
...
vm_map_t
db_map_addr(vm_offset_t a/* addr */)
{
#if 0
	thread_t	thread;
