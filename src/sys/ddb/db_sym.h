...
typedef struct {
	...
	char		*end;
	void		*machdep;	/* optional machdep pointer */
} db_symtab_t;
...
extern bool	db_qualify_ambiguous_names;
 ...
 */
int db_add_symbol_table (char *, char *, const char * name, void *);
...
bool db_eqname (const char *, const char *, char);
