    ...
    int stream_size;
{
    ...
    s->window = (uint8_tf *) ZALLOC(strm, s->w_size, 2*sizeof(uint8_t));
    ...
    IPos cur_match;                             /* current match */
{
    ...
    register uint8_tf *scan = s->window + s->strstart; /* current string */
    register uint8_tf *match;                       /* matched string */
     ...
     */
    register uint8_tf *strend = s->window + s->strstart + MAX_MATCH - 1;
    register ush scan_start = *(ushf*)scan;
    register ush scan_end   = *(ushf*)(scan+best_len-1);
#else
    register uint8_tf *strend = s->window + s->strstart + MAX_MATCH;
