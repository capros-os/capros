...
CMTELINK=$(CMMELINK) $(CMTESTART)
# libs given at the end of the link command:
CMTELIBS=$(CAPROS_DOMAIN)/libcmte.a $(CMMELIBS)
CMTEDEPS=$(CMTELIBS) $(CMTESTART) $(CMMEDEP)
...
DYNCMMESTART=$(CAPROS_DOMAIN)/dyncmmestart.o
DYNCMMELINK=$(EROS_GCC) $(CMMELINKOPT) $(DYNCMMESTART)
DYNCMMEDEPS=$(LIBDEP) $(CMMELIBS) $(DYNCMMESTART)

DYNCMTESTART=$(CAPROS_DOMAIN)/dyncmtestart.o
DYNCMTELINK=$(DYNCMMELINK) $(DYNCMTESTART)
DYNCMTEDEPS=$(DYNCMMEDEPS) $(CMTELIBS) $(DYNCMTESTART)
